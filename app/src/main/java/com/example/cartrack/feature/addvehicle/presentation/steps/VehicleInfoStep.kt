...
internal fun VehicleInfoStep(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            supportingText = {
                if (mileageError != null) Text(mileageError, color = MaterialTheme.colorScheme.error)
                else Text("Enter numbers only", color = MaterialTheme.colorScheme.onSurfaceVariant)
            },
